...
var file_qa_proto_rawDesc = []byte{
	0x0a, 0x08, 0x71, 0x61, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x71, 0x61, 0x22, 0x1d,
	...
	0x02, 0x51, 0x61, 0x12, 0x21, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x0b, 0x2e, 0x71, 0x61,
	0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0c, 0x2e, 0x71, 0x61, 0x2e, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x71, 0x61, 0x62, 0x06,
...
var file_qa_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_qa_proto_goTypes = []any{
	(*Request)(nil),  // 0: qa.Request
	(*Response)(nil), // 1: qa.Response
}
var file_qa_proto_depIdxs = []int32{
	0, // 0: qa.Qa.Ping:input_type -> qa.Request
	1, // 1: qa.Qa.Ping:output_type -> qa.Response
...
func file_qa_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_qa_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_qa_proto_msgTypes[1].Exporter = func(v any, i int) any {
