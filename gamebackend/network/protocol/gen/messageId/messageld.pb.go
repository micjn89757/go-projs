...
func (MessageId) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_messageld_proto_enumTypes[0].Descriptor()
}

func (MessageId) Type() protoreflect.EnumType {
	return &file_proto_messageld_proto_enumTypes[0]
}
...
func (MessageId) EnumDescriptor() ([]byte, []int) {
	return file_proto_messageld_proto_rawDescGZIP(), []int{0}
}

var File_proto_messageld_proto protoreflect.FileDescriptor

var file_proto_messageld_proto_rawDesc = []byte{
	0x0a, 0x15, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x6c,
...
var (
	file_proto_messageld_proto_rawDescOnce sync.Once
	file_proto_messageld_proto_rawDescData = file_proto_messageld_proto_rawDesc
)

func file_proto_messageld_proto_rawDescGZIP() []byte {
	file_proto_messageld_proto_rawDescOnce.Do(func() {
		file_proto_messageld_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_messageld_proto_rawDescData)
	})
	return file_proto_messageld_proto_rawDescData
}

var file_proto_messageld_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_messageld_proto_goTypes = []any{
	(MessageId)(0), // 0: messageId.MessageId
}
var file_proto_messageld_proto_depIdxs = []int32{
...
func init() { file_proto_messageld_proto_init() }
func file_proto_messageld_proto_init() {
	if File_proto_messageld_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_messageld_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_messageld_proto_goTypes,
		DependencyIndexes: file_proto_messageld_proto_depIdxs,
		EnumInfos:         file_proto_messageld_proto_enumTypes,
	}.Build()
	File_proto_messageld_proto = out.File
	file_proto_messageld_proto_rawDesc = nil
	file_proto_messageld_proto_goTypes = nil
	file_proto_messageld_proto_depIdxs = nil
}
